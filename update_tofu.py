...
INDEX_URL = 'https://api.github.com/repos/opentofu/opentofu/releases'
FETCH_URL = 'https://github.com/opentofu/opentofu/releases/download/v{version}/tofu_{version}_linux_amd64.zip'
SAVED_ZIPBALL_PATH = '~/Software/opentofu_{version}_linux_amd64.zip'
UNPACK_PATH= '~/Software/opentofu/bin'
SYMLINK_PATH = '~/Software/opentofu/bin/terraform'
...
def main():
    ...
    target_path = unpack_path / f'tofu-{version}'
    with zipfile.ZipFile(saved_zipball) as archive:
        with archive.open('tofu') as source, \
